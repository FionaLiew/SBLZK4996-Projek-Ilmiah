...
function WordSearchController(gameId, listId, solveId, newGameId, themeId, challengeId, timerId) {
	...
	var searchTypes = {
		...
		"Imbuhan Awalan Latihan 1 🕹️": [["menulis", "pemadam", "terbesar", "berlari"],
			["penyanyi", "menyapu", "berasa", "terajin"]],

		"Imbuhan Awalan Latihan 2 🕹️": [["pengecat", "tercantik", "melawat", "berekor"],
			["mengkategori",  "pemfitnah",  "belajar", "terasa"]],
